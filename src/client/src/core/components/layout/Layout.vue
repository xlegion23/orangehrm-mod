<template>
  <oxd-layout :class="{
    ...
    <template #user-actions>
      <li>
        <a href="#" role="menuitem" class="oxd-userdropdown-link" @click="openAboutModel">
          {{ $t('general.about') }}
        </a>
      </li>
      <li>
    ...
    <template #nav-actions>
      <oxd-icon-button name="question-lg" :title="$t('general.help')" @click="onClickSupport" />
    </template>
  </oxd-layout>
...
.orangehrm-upgrade-layout {
  .oxd-topbar-header-userarea {
    ...
    align-items: center;
    /* Ensures it stays vertically aligned */
    margin-left: auto;
