 ...
 */
class I18NImportError extends \OrangeHRM\Entity\I18NImportError implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\I18NImportError' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\I18NImportError' . "\0" . 'langString', '' . "\0" . 'OrangeHRM\\Entity\\I18NImportError' . "\0" . 'language', '' . "\0" . 'OrangeHRM\\Entity\\I18NImportError' . "\0" . 'error', '' . "\0" . 'OrangeHRM\\Entity\\I18NImportError' . "\0" . 'importedBy', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (I18NImportError $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getError(): \OrangeHRM\Entity\I18NError
    {
     ...
     * {@inheritDoc}
     */
    public function setError(\OrangeHRM\Entity\I18NError $error): void
    {
     ...
     * {@inheritDoc}
     */
    public function getImportedBy(): \OrangeHRM\Entity\Employee
    {
     ...
     * {@inheritDoc}
     */
    public function setImportedBy(\OrangeHRM\Entity\Employee $importedBy): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImportedBy', [$importedBy]);

        parent::setImportedBy($importedBy);
    }
